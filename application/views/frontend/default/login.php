                          ...
                          <div class="content-box">
                              <div class="basic-group">
                                  <div class="form-group">
                                      <label for="login-email"><span class="input-field-icon"><i class="fas fa-user"></i></span> Student ID:</label>
                                      <input type="text" class="form-control" name = "email" id="login-email" placeholder="Student ID" value="" required>
                                  </div>
                                  <div class="form-group">

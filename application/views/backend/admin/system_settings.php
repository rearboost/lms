...
<div class="row">
    ...
    <div class="col-xl-5">
       ...
       <div class="card">
            <div class="card-body">
                <div class="col-lg-12">
                    <h4 class="mb-3 header-title"><?php echo get_phrase('update_login_status_all_0');?></h4>
                    <form action="<?php echo site_url('login/log_update'); ?>" method="post">
                         <button type="submit" class="btn btn-primary"><?php echo get_phrase('log_update'); ?></button>
                    </form>
                    <br>
                    <label><?php echo get_phrase('current_login_method -'); ?></label>
                    <labelfor="file_name"><?php echo get_settings('login_method');  ?></label><br>
                    <label><?php echo get_phrase('1 - Can not login Multiple'); ?></label><br>
                    <label><?php echo get_phrase('0 - Can login Multiple'); ?></label>
                </div>
            </div> <!-- end card body-->
        </div>
    </div>

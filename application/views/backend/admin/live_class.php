<?php $live_class = $this->db->get_where('live_class', array('course_id' => $course_id))->row_array(); date_default_timezone_set('Asia/Colombo'); ?>
<div class="tab-pane" id="live-class">
    <div class="row" id="live-class-area">
        <div class="col-md-7">
            ...
            <div class="form-group row mb-3">
                <label class="col-md-4 col-form-label" for="live_class_schedule_time"><?php echo get_phrase('live_class_schedule') . ' (' . get_phrase('start_time') . ')'; ?></label>
                <div class="col-md-6">
            ...
            <div class="form-group row mb-3">
                <label class="col-md-4 col-form-label" for="live_class_schedule_end_time"><?php echo get_phrase('live_class_schedule') . ' (' . get_phrase('end_time') . ')'; ?></label>
                <div class="col-md-6">
                    <input type="text" name="live_class_schedule_end_time" id="live_class_schedule_end_time" class="form-control" data-toggle="timepicker" value="<?php echo date('h:i:s A', $live_class['end_time']); ?>">
                </div>
            </div>
            <div class="form-group row mb-3">
            ...
            <div class="form-group row mb-3">
                ...
                <div class="col-md-6">
                    <input type="text" class="form-control" id="zoom_meeting_url" name="zoom_meeting_url" value="<?php echo $live_class['zoom_meeting_url']; ?>"  >
                </div>
            </div>
        </div>
        <div class="col-md-5">
